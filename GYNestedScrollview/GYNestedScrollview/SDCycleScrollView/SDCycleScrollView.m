...
//            NSString *url=staticUrl;
//            [cell.imageView sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@%@",url,imagePath]] placeholderImage:self.placeholderImage];
